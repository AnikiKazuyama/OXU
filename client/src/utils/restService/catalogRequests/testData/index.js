  ...
  data: [
    {
      ...
      preview: 'https://upload.wikimedia.org/wikipedia/en/f/f8/Bokunopico.jpg',
    ...
    },
    {
      ...
      preview: 'https://upload.wikimedia.org/wikipedia/en/thumb/9/94/NarutoCoverTankobon1.jpg/220px-NarutoCoverTankobon1.jpg',
    ...
    },
    {
      ...
      preview: 'https://s3.anilist.co/media/manga/cover/medium/25-imy9GeynfS89.jpg',
    ...
    },
    {
      ...
      preview: 'https://s3.anilist.co/media/manga/cover/large/nx31706-8NapvUJrWR3C.png',
    ...
    },
    {
      ...
      preview: 'https://s3.anilist.co/media/manga/cover/large/nx63327-VpmcwQGbXZh5.jpg',
    ...
    },
    {
      ...
      preview: 'https://s3.anilist.co/media/manga/cover/medium/55486-ut4ycwzuWEMF.png',
    ...
    },
    {
      ...
      preview: 'https://s3.anilist.co/media/manga/cover/medium/12-UvTZ3kLjNVAV.png',
...
class CatalogDeliver {
  static getCatalog(page = 1, offset = 2, filterOptions) {
    const items = catalogData.data.length;
    const pages = Math.round(items / offset);
